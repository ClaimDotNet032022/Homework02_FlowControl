...
namespace FlowControlHomework
{
    ...
    public class FlowControlHomework
    {
        ...
        public void Switch()
        {
            ...
            number = 42; //Assign me so I cause the next switch to pass.
            switch (number)
            {
                case 15:
                    Console.WriteLine(false);
