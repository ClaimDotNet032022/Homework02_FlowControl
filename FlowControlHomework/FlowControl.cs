...
namespace FlowControlHomework
{
    ...
    public void Switch(string v)
    {
        ...
        number = default; //Assign me so I cause the next switch to pass.
        switch (number)
        {
            case 15:
                Console.WriteLine(false);
        ...
        string usersChoice2 = "a";
        switch (usersChoice2) // Fix me so I compile
        {
            case "a":
                Assert.IsTrue(true);
                break;
        ...
        string usersChoice3 = "a";
        switch (usersChoice3) // Fix me so I compile
        {
            case "a":
                Assert.IsTrue(true);
                break;
